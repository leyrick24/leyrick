<template>
	<div class="col-md-12">
		...
		<div v-if="displayMode=='room'" id="RoomMap" class="d-flex justify-content-center position-absolute" style="top:0px;height:100%;width:100%">
			<div class="row position-absolute right-250">
...
<script type="text/javascript">
	export default{
		...
		methods:{
			...
			//Function Description: Selects room on click
			//Param: room, event, hilight_key
			...
			//Function Description: Selects device on click
