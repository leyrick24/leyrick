<template>
	<div class="row">
		...
		<div class='col-md-6'>
			<img :src="status==true ? '/img/devices/motion_alarm_on.png' : '/img/devices/motion_alarm_off.png'" class='device-icon center-block'>
		</div>
		<div class='col-md-3'>
		</div>
	</div>
	...
	export default{
		...
		data(){
			return{
				...
				device_type:'motion_detector',		//Device type
			}
		},
		created(){
		...
		methods:{
			...
			//Function Description: Change displayed image to indicate if device is triggered status
			//Param: data (device)
			readDeviceData(data){
