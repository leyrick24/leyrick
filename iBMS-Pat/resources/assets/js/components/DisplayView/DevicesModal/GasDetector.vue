<template>
	<div class="row">
		...
		<div class='col-md-6'>
			<img :src="status==true ? '/img/devices/gas_detector_on.png' : '/img/devices/gas_detector_off.png'" class='device-icon center-block'>
		</div>
		<div class='col-md-3'>
		</div>
	</div>
	...
	export default{
		...
		data(){
			return{
				...
				device_type:'gas_detector',		//Device Type
			}
		},
		created(){
		...
		methods:{
			...
			//Function Description: Change displayed image to indicate gas detector status
			//Param: data (device)
			readDeviceData(data){
